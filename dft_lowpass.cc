// Example : apply low pass filtering to input image/video
...
int main( int argc, char** argv )
{
  ...
  char const * lowPassName = "Low Pass Filtered (grayscale)"; // window name
